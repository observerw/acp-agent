...
This project provides a friendly and intuitive CLI for the [ACP Registry](https://github.com/agentclientprotocol/registry), enabling developers to quickly browse, search, and run ACP (Agent Client Protocol) agents.
